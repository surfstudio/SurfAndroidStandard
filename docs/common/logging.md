...
Логгирование в logcat осуществляется с помощью [Logger](../../logger/lib-logger/README.md).
...
и [тело ответа сервера](../../deprecated/converter-gson/lib-converter-gson/README.md).
