...
public abstract class CoreFrameLayoutView extends FrameLayout implements CoreWidgetViewInterface {
    ...
    public CoreFrameLayoutView(Context context, boolean isManualInitEnabled, int widgetId) {
        super(context, null);
    ...
    private void obtainAttrs(AttributeSet attrs) {
        TypedArray ta = getContext().obtainStyledAttributes(attrs, R.styleable.CoreFrameLayoutView, -1, -1);
        isManualInitEnabled = ta.getBoolean(R.styleable.CoreFrameLayoutView_enableManualInit, false);
        ta.recycle();
    }
