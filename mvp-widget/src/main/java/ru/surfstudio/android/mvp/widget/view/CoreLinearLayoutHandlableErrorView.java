...
public abstract class CoreLinearLayoutHandlableErrorView extends CoreLinearLayoutView implements HandleableErrorView {

    @Inject
    ErrorHandler errorHandler;

    public CoreLinearLayoutHandlableErrorView(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public CoreLinearLayoutHandlableErrorView(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
    }

    @TargetApi(21)
    public CoreLinearLayoutHandlableErrorView(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
