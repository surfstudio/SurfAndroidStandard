 ...
 */
class CycledScreenConfigurator(intent: Intent) : DefaultActivityScreenConfigurator(intent) {

    @PerScreen
    @Component(dependencies = [DefaultActivityComponent::class],
            modules = [DefaultActivityScreenModule::class, CycledScreenModule::class])
    internal interface CycledScreenComponent
        : ScreenComponent<CycledActivityView>
    ...
    override fun createScreenComponent(defaultActivityComponent: DefaultActivityComponent,
        ...
        return DaggerCycledScreenConfigurator_CycledScreenComponent.builder()
                .defaultActivityComponent(defaultActivityComponent)
                .defaultActivityScreenModule(defaultActivityScreenModule)
                .cycledScreenModule(CycledScreenModule(CycledActivityRoute()))
                .build()
    }
}
