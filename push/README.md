...
6. Чтобы группировка работало, инициализируйте/переопределите переменную group в `PushHandleStrategy`.
   Для каждой стратегии можно обявит свою группировку. Таким образом каждая уведомления из гаждой стратегии будет сгруппироваться в отдельные группы.
