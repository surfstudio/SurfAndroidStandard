 ...
 *
 * Подразумевается, что NoDataItemController должен иметь единичный instance, если их больше одного, то может возникнуть креш с ошибкой:
 * java.lang.IllegalStateException: Two different ViewHolders have the same stable ID. Stable IDs in your adapter MUST BE unique and SHOULD NOT change.
 * Для того, чтобы от неё избавиться, необходимо переопределить метод getItemId(), чтобы он возвращал различные ID. Например: item.hashCode()
 *
