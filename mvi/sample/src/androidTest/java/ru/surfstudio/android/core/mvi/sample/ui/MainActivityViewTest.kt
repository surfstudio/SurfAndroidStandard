...
import ru.surfstudio.android.sample.common.test.utils.RecyclerViewUtils.scrollTo
import ru.surfstudio.android.sample.common.test.utils.RecyclerViewUtils.scrollToBottom
...
class MainActivityViewTest : BaseSampleTest<MainActivityView>(MainActivityView::class.java) {
    ...
    fun testMviSample() {
        ...
        onView(withId(R.id.input_et)).perform(typeText("message"), closeSoftKeyboard())
        performClick(R.id.submit_btn)
        checkIfSnackbarIsVisible(R.string.message)
