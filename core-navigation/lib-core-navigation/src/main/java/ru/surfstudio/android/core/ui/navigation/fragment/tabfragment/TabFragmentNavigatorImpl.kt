...
open class TabFragmentNavigatorImpl(
    ...
    private val EXTRA_CURRENT_TAB_TAG: String = TabFragmentNavigatorImpl::class.toString() + "CURRENT_TAB_TAG"
    private val EXTRA_CURRENT_FRAGMENT: String = TabFragmentNavigatorImpl::class.toString() + "CURRENT_FRAGMENT_TAG"
    private val EXTRA_FRAGMENT_STACK: String = TabFragmentNavigatorImpl::class.toString() + "FRAGMENT_STACK"
    ...
    override val backPressedEventObservable: Observable<OnBackPressedEvent> get() = onBackPressEventSubject

    private val activeTabReOpenSubject = PublishSubject.create<Unit>()
    override val activeTabReOpenObservable: Observable<Unit> get() = activeTabReOpenSubject
    ...
    override fun <T> showAtTab(tabRoute: T, fragmentRoute: FragmentRoute, clearStack: Boolean)
