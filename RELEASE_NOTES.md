...
* Добавлена возможность изменения скорости выполнения запроса
    * На экране DebugScreen в настройках сервера можно изменить скорость запроса 0c, 0.5c 1c 2c 4c 8c
