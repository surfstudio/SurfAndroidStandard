...
* ANDDEP-669 Добавлена возможность возвращать результат из фрагмента. Отсутствует обратная сомвестимость (расширен конструктор)
...
#### message-controller
#### mvp-dialog
* Добавлена возможность возвращать результат из диалога. Отсутствует обратная сомвестимость (расширен конструктор)
