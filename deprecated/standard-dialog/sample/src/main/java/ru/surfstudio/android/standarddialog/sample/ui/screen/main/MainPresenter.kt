...
internal class MainPresenter @Inject constructor(
    ...
    override fun simpleDialogPositiveBtnAction(dialogTag: String) {
        showMessage(
                dialogTag,
                resourceProvider.getString(R.string.first_dialog_accepted),
                resourceProvider.getString(R.string.second_dialog_accepted)
        )
    }
    ...
    override fun simpleDialogNegativeBtnAction(dialogTag: String) {
        showMessage(
                dialogTag,
                resourceProvider.getString(R.string.first_dialog_canceled),
                resourceProvider.getString(R.string.second_dialog_canceled)
        )
    }

    fun showFirstDialog() {
        dialogNavigator.show(StandardDialogRoute(
                title = resourceProvider.getString(R.string.first_dialog_title),
                message = resourceProvider.getString(R.string.first_dialog_message),
                positiveBtnText = "yes",
                negativeBtnText = "no",
