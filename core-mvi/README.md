...
Содержит единственный метод `reduce(state, event): state`, в котором с помощью текущего состояния экрана и события происходит получение нового состояния. 
...
![Data Flow Diagram]( https://im5.ezgif.com/tmp/ezgif-5-78df489db979.jpg )
...
![Linear Data Flow]( https://im5.ezgif.com/tmp/ezgif-5-b1b1a36eb131.jpg )
