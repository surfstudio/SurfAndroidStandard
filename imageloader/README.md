...
Указание URI-ссылки на изображение или видео.
...
### frame
* frame(frameTimeMs: Long)
    
Указание кадра видео, который будет отображаться, если в качестве загружаемого ресурса видео.
Показывает кадр на задаваемой миллисекунде `frameTimeMs`
