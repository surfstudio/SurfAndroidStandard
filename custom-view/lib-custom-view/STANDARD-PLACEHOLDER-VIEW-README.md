...
- [ИНТЕГРАЦИЯ С CORE-MVP](#интеграция-с-core-mvp)
- [НАСТРОЙКА И СТИЛИЗАЦИЯ](#настройка-и-стилизация)
  - [СОЗДАНИЕ КАСТОМНОГО СТИЛЯ](#создание-кастомного-стиля)
  - [ПРИМЕНЕНИЯ СТИЛЯ](#применения-стиля)
  - [СТИЛЕВЫЕ АТРИБУТЫ](#стилевые-атрибуты)
- [ПОДДЕРЖИВАЕМЫЕ ПРОГРЕСС-ИНДИКАТОРЫ](#поддерживаемые-прогресс-индикаторы)
