...
pipeline.stages = [
        ...
        pipeline.stage(ADD_LICENSE, StageStrategy.SKIP_STAGE) {
        ...
        pipeline.stage(BUILD) {
            AndroidPipelineHelper.buildStageBodyAndroid(script, "clean :easyadapter-sample:assembleDebug")
        },
