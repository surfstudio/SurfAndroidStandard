...
public abstract class CoreFrameLayoutHandlableErrorView extends CoreFrameLayoutView implements HandleableErrorView {

    @Inject
    ErrorHandler errorHandler;

    public CoreFrameLayoutHandlableErrorView(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public CoreFrameLayoutHandlableErrorView(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
    }

    @TargetApi(21)
    public CoreFrameLayoutHandlableErrorView(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
