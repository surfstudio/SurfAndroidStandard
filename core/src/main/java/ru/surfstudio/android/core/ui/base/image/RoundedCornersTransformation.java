...
/**
 * Трансформатор для обрезания углов изображения.
 * Можно обрезать каждый угол отдельно.
 * А так же указать отступ от краев
 */
public class RoundedCornersTransformation implements Transformation<Bitmap> {
     ...
     * Конструктор
     *
     * @param context действующий контекст
     ...
     * Конструктор
     *
     * @param pool       пул изображения для переиспользования
     * @param radius     радиус угла в пикселях
     * @param margin     отступ от края в пикселях
     * @param cornerType угол
     */
    public RoundedCornersTransformation(BitmapPool pool, int radius, int margin,
                                        CornerType cornerType) {
        mBitmapPool = pool;
