...
import ru.surfstudio.android.core.app.interactor.common.network.connection.ConnectionQualityProvider;
import ru.surfstudio.android.core.app.interactor.common.network.error.NotModifiedException;
        ...
        return cacheRequest
                ...
                .onErrorResumeNext(throwable ->
                        this.processErrorFinal(
                                throwable,
                                networkRequestCreator.call(ServerConstants.QUERY_MODE_FORCE)));
    }
