...
class ActivityResultDelegate(
    ...
    fun onActivityResult(requestCode: Int, resultCode: Int, data: Intent?) {
        screenResultEmitter.getObservedRoutes().forEach { route ->
            val activityResultRoute = route as? ActivityResultRoute<ActivityResultData<Serializable>>
    ...
    private fun emitActivityResult(route: ActivityResultRoute<ActivityResultData<Serializable>>, resultCode: Int, data: Intent?) {
