...
class Tab1FragmentRoute(val id: Int) : FragmentWithParamsRoute(), RootFragmentRoute {
    ...
    override fun getFragmentClass(): Class<out Fragment> = Tab1FragmentView::class.java
}