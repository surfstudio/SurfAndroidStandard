...
object LocationErrorsResolver {
    ...
    /**
     * Решить проблемы связанные с невозможностью получения метоположения.
     *
     * @param resolvingExceptions [List], содержащий исключения связанные с невозможностью получения метоположения.
     * @param resolutions [List], содержащий решения проблем связанных с невозможностью получения метоположения.
